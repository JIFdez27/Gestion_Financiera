...
Como modelo adicional se utilizó el método de valorización de Monte Carlo. Este se basa en la capacidad de estimar el valor esperado (o promedio) del rendimiento o payoff de una opción utilizando múltiples simulaciones de escenarios aleatorios del precio del activo subyacente.
